package com.IliaDuhov.PastebinLike.controller;

import com.IliaDuhov.PastebinLike.payload.FileResponse;
import com.IliaDuhov.PastebinLike.service.FileStorageService;
...
@Tag(name = "Files operations", description = "File Service description")
